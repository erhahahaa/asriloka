...
<body class="bg-light">
                    ...
                    <div class="card-body border-0 shadow-sm">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="form-check form-switch">
                                <form>
                                    <input onchanges="upd_shutdown(this.value)" class="form-check-input" type="checkbox"
                                        id="shutdown-toogle">
                                </form>
                            </div>
                        </div>
    ...
    <script>
        ...
        function upd_general(site_title_val, site_about_val) {
            ...
            xhr.send('set_title=' + site_title_val + '&site_about=' + site_about_val + '&upd_general');
        }
        ...
        function get_contacts() {
            let contacts_p_id = ['address', 'gmap', 'pn1', 'email', 'insta', 'wa', 'yt', 'tt'];
